...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    private WebServices.Asynchtask callback=null;

    public WebServices.Asynchtask getCallback() {
        return callback;
    }
    public void setCallback(WebServices.Asynchtask callback) {
     ...
     */
    public  WebService(String urlWebService,Map<String, String> data, Context activity, WebServices.Asynchtask callback) {
